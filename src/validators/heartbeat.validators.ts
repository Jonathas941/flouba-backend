...
export const heartbeatSchema = z.object({
  ...
  terminalConnected: z.boolean().optional().default(false),
  brokerConnected: z.boolean().optional().default(false),
  marketConnected: z.boolean().optional().default(false),
  lastTickTime: z.coerce.date().optional(),
  lastTradeTime: z.coerce.date().optional(),
  lastCommandTime: z.coerce.date().optional(),
  balance: number,
  equity: number.optional().default(0),
  margin: number.optional().default(0),
  freeMargin: number.optional().default(0),
  marginLevel: number.optional().default(0),
  floatingProfit: number.optional().default(0),
  dailyProfit: number.optional().default(0),
  dailyLoss: number.optional().default(0),
  dailyNetProfit: number.optional().default(0),
  drawdownPercent: number.optional().default(0),
  maxDrawdownPercent: number.optional(),
  openPositionCount: z.coerce.number().int().min(0).optional().default(0),
  pendingOrderCount: z.coerce.number().int().min(0).optional().default(0), currentSpread: number.optional(), averageSpread: number.optional(),
